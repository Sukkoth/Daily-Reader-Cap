    ...
    <div className="space-y-3">
      {favorites.map((item: Reading) => (
        <div
          ...
          key={item.date}
          className="dark:bg-shade-2 bg-light-2 border-border-light dark:border-border-shade flex justify-between rounded-xl border p-4"
        >
          <div className="max-w-4/5">
            <h1 className="text-xl font-medium">{item.readings[0].book}</h1>
            <p className="line-clamp-2 pt-2 text-gray-600 dark:text-gray-300">
